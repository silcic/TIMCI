...
tab_antibio_app <- sum.tab(d0[which(d0$single_diag==1 & d0$antibio_req==1),], "antibio_app", "pre_post")
...
tab_antibio_unapp <- sum.tab(d0[which(d0$single_diag==1 & d0$antibio_req==0),], "antibio_unapp", "pre_post")
...
tab_antibio_first_line <- sum.tab(d0[which(!is.na(d0$antibio_first_line)),], "antibio_first_line", "pre_post")
...
tab_feb_mal <- sum.tab(d0[which(d0$fev_flag==1),], "mal_flag", "pre_post")
...
tab_pos_mal <- sum.tab(d0[which(d0$mal_flag==1 & d0$malaria_res==2),], "antimal_flag", "pre_post")
...
##proportion of positive malaria children (denominator) prescribed with antimalarial
tab_neg_mal <- sum.tab(d0[which(d0$mal_flag==1 & d0$malaria_res==1),], "antimal_flag", "pre_post")
...
##proportion of positive malaria children (denominator) prescribed with antimalarial
tab_un_mal <- sum.tab(d0[which(d0$mal_flag==0),], "antimal_flag", "pre_post")
